    ...
    return (
        <div className='flex flex-col justify-start items-center gap-4 w-full rounded-3xl  bg-[#1a1a1a] p-6 md:p-8 shadow-lg hover:scale-105 transition-all duration-300'>
            ...
            <div className='flex flex-col md:flex-row justify-center space-y-4 md:space-y-0 md:space-x-4 py-12 w-full'>
                <a target='blank' href={source}><Button className='px-6 py-3 border-[#BB86FC] text-[#BB86FC] text-lg md:text-xl font-normal rounded-lg shadow-md transition-all hover:scale-105 duration-300' variant="outlined">Source Code</Button></a>
                <a target='blank' href={demo}><Button className='px-6 py-3 bg-[#BB86FC] text-[#121212] text-lg md:text-xl font-normal rounded-lg shadow-md hover:bg-[#9B6FEF] transition-all hover:scale-105 duration-300' variant="contained">Demo</Button></a>
            </div>
        </div>
    )
}
