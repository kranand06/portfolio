...
function Home() {
  return (
    <div id='home' className='flex flex-col lg:flex-row justify-between items-center  lg:items-start  w-full p-10 lg:p-20 bg-[#121212] text-[#E0E0E0]'>
      ...
      <div className='w-full lg:w-[50%] lg:pt-10 text-center lg:text-left flex flex-col justify-center gap-8'>
        ...
        <a href="mailto:kranand9430@gmail.com"><Button className='px-6 py-3 bg-[#BB86FC] text-[#121212] text-lg md:text-xl font-normal rounded-lg shadow-md hover:bg-[#9B6FEF] transition-all hover:scale-105 duration-300' variant="contained">Contact Me!</Button></a>
      ...
      <div className='w-full h-auto lg:w-[50%] flex justify-center mt-10 lg:mt-0'>
        <img src="image/HeroPage.png" alt="my pic Png hero" className='w-[80%] md:w-[80%] rounded-full' />
      </div>
    </div>
  )
}
