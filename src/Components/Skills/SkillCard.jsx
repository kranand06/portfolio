...
function SkillCard({ id, title, icon }) {
    return (
        <div className='flex flex-col justify-center items-center gap-2 w-32 sm:w-48 rounded-3xl  bg-[#1a1a1a] p-4 sm:p-8 sm:my-5 mx-auto hover:scale-105 transition-all duration-300'>
