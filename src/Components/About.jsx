        ...
        <div className=' bg-[#1a1a1a] rounded-lg shadow-lg p-3 lg:p-10'>
            ...
            <div className='flex flex-col justify-center lg:flex-row lg:justify-between items-center my-3 lg:my-10'>
                <div className='w-full lg:w-[60%] '>
                    ...
                    <AboutCard title='Vlogger' img='icons/vlog.png' description='Other than tech I have started vlogging as my hobby. I create and upload short-vlog on insta and youtube.' />
                </div>
